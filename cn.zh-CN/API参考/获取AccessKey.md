...
3.  在**安全提示**页面，选择获取主账号还是子账号的AccessKey。
    ...
    ![](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1266654061/p48002.png)
...
4.  获取账号AccessKey。
    ...
    -   获取主账号AccessKey
        ...
        4.  在新建用户AccessKey页面，展开**AccessKey详情**，查看AccessKey ID和AccessKey Secret。可以单击**保存AK信息**，下载AccessKey信息。
            ...
            ![](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/8947359951/p48003.png)
    ...
    -   获取子账号AccessKey
        ...
        6.  在创建AccessKey页面，查看AccessKey ID和AccessKey Secret。可以单击**下载CSV文件**，下载AccessKey信息或者单击**复制**，复制AccessKey信息。
            ...
            ![](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1266654061/p48004.png)
