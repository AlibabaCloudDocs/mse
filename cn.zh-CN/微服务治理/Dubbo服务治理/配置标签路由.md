...
3.  在**无状态（Deployment）**页面右上角单击**使用镜像创建**。

4.  在**创建应用**页面分别创建两个无状态应用cartservice1和cartservice2。
...
7.  在**创建标签路由**页面设置参数，然后单击**确定**。
    ...
    ![创建标签路由-Dubbo](https://static-aliyun-doc.oss-accelerate.aliyuncs.com/assets/img/zh-CN/2959209951/p127219.png)
